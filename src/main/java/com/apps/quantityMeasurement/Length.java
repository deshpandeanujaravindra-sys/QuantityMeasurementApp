...
public class Length {
    ...
    public static Length add(Length length, Length length2, LengthUnit targetUnit) {
        ...
        double firstConvertedValue = convert(length.value, length.unit, length.getUnit());
        double secondConvertedValue = convert(length2.value, length2.unit, length.getUnit());
        double addition = (firstConvertedValue + secondConvertedValue) / targetUnit.conversionFactor;
        return new Length((addition), targetUnit);
